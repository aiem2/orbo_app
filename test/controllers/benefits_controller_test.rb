...
class BenefitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create benefit" do
    assert_difference("Benefit.count") do
      post benefits_url, params: { benefit: { city: @benefit.city, date_end: @benefit.date_end, date_start: @benefit.date_start, description: @benefit.description, partner_id: @benefit.partner_id, state: @benefit.state } }
    end
  ...
  test "should update benefit" do
    patch benefit_url(@benefit), params: { benefit: { city: @benefit.city, date_end: @benefit.date_end, date_start: @benefit.date_start, description: @benefit.description, partner_id: @benefit.partner_id, state: @benefit.state } }
