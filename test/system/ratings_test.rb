...
class RatingsTest < ApplicationSystemTestCase
  ...
  test "should create rating" do
    ...
    fill_in "Date service", with: @rating.date_service
    fill_in "Description", with: @rating.description
    fill_in "Partner", with: @rating.partner_id
    fill_in "Rate", with: @rating.rate
    fill_in "Segment", with: @rating.segment
    fill_in "Type service", with: @rating.type_service
